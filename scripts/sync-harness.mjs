...
<p class="sub" style="font-size:12px;color:#94A3B8;font-style:italic;margin-bottom:14px">🐈‍⬛ 히로 (HIRO) — 본 하네스의 마스코트 검은 고양이. 부트스트랩 시나리오 같은 대화형 작업에서 친근한 안내자로 말을 건넵니다.</p>
