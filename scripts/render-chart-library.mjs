...
export function renderChartLibraryHTML({ adminMode = false } = {}) {
  ...
  const topBar = adminMode
    ...
    : '<div class="top"><span style="font-size:14px;color:#64748B">정적 미러 — /hiro/chart-library 의 그 시점 스냅샷</span></div>'
...
.intro{background:var(--bg-card);border:1px solid var(--border);border-radius:12px;padding:18px 22px;margin-bottom:24px;font-size:16px;color:var(--text-desc)}
.intro strong{color:var(--text-strong)}
.intro code{background:var(--bg-code);color:#F8C4D7;padding:2px 8px;border-radius:4px;font-family:ui-monospace,Menlo,Consolas,monospace;font-size:15px}
...
.section-desc{font-size:15px;color:var(--text-sub);margin-bottom:14px;padding-left:15px}
...
.chart-code{font-size:14px;font-weight:700;letter-spacing:1px;text-transform:uppercase;margin-bottom:4px;font-family:ui-monospace,Menlo,Consolas,monospace}
.chart-name{font-size:17px;font-weight:700;color:var(--text-strong);margin-bottom:10px}
.chart-svg{margin-bottom:10px}
.chart-desc{font-size:15px;color:var(--text-desc);margin-bottom:8px;line-height:1.5}
.chart-usage{font-size:14px;color:var(--text-sub);margin-bottom:6px}
.chart-usage strong{color:var(--text-desc)}
.chart-cmd{font-size:14px;color:var(--text-muted);border-top:1px solid var(--border);padding-top:6px;margin-top:6px}
...
@media (max-width:780px){
  ...
  h1{font-size:22px}
  .sub{font-size:15px;margin-bottom:18px}
  .intro{padding:14px 16px;margin-bottom:18px;font-size:15px}
  .section{margin-bottom:22px}
  .section-title{font-size:18px;padding-left:10px}
  .section-desc{font-size:14px;margin-bottom:10px}
  .chart-grid{grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:12px}
  .chart-card{padding:12px 14px}
  .chart-name{font-size:16px;margin-bottom:8px}
  .chart-desc{font-size:14px}
}
/* ─── 적응형 UI — 모바일 (≤ 480px) ───────────────────────────────── */
@media (max-width:480px){
  ...
  .intro ul{margin-left:18px;font-size:12.5px}
  .chart-grid{grid-template-columns:1fr;gap:10px}
  .chart-card{padding:10px 12px}
  .chart-svg svg{width:100%;height:auto}
  .chart-desc{font-size:14px;line-height:1.4}
  .chart-usage,.chart-cmd{font-size:11.5px}
}
</style></head><body>
