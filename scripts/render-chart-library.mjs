...
@media (max-width:780px){
  ...
  .intro{padding:14px 16px;margin-bottom:18px;font-size:13px}
  .section{margin-bottom:22px}
  .section-title{font-size:16px;padding-left:10px}
  ...
  .chart-name{font-size:14px;margin-bottom:8px}
...
@media (max-width:480px){
  ...
  .chart-desc{font-size:12px;line-height:1.4}
