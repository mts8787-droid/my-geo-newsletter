...
.notice{text-align:left;background:#1E293B;border:1px solid #334155;border-radius:10px;padding:20px 22px;margin-bottom:32px;font-size:12px;line-height:1.85;color:#94A3B8;width:1080px;max-width:92vw;margin-left:50%;transform:translateX(-50%)}
.notice strong{color:#E2E8F0;font-weight:700}
.notice .en{display:block;color:#64748B;margin-top:4px}
...
<div class="wrap">
  ...
  <div class="notice">
    ...
    <p class="en">This Letter aims to help systematically manage brand exposure and citation sources in major LLM responses by sharing <strong>1) how visibly our brand appears</strong> in response to consumer queries within LLM services such as ChatGPT and Gemini, and <strong>2) the main citation sources</strong> when LLM services mention our brand.</p>
    <br>
    ...
    <p class="en">Targeting <strong>10 key countries</strong> (the US, UK, Germany, Brazil, India, Mexico, Spain, Australia, Vietnam, and Canada), it presents how generative AI understands and utilizes LG Electronics by market and product category, based on brand exposure <strong>Visibility</strong>, source-site <strong>Citation</strong>, and content <strong>AI Readability (%)</strong> metrics.</p>
    <br>
    <p>또한 경쟁사와의 비교 분석을 통해 카테고리별·국가별 개선 영역을 도출하고 실질적인 전략 인사이트를 확보할 수 있도록 구성했습니다.</p>
    <p class="en">It is also designed to derive improvement areas by category and country through comparative analysis with competitors, enabling the acquisition of practical strategic insights.</p>
  </div>
  <div class="links">
    <p class="section-label">Newsletter</p>
    <a class="btn btn-ko" href="/p/${nl.koSlug}">한국어 리포트</a>
    <a class="btn btn-en" href="/p/${nl.enSlug}">English Report</a>
    <p class="section-label">Dashboard</p>
    <a class="btn btn-ko" href="/p/${dash.koSlug}">한국어 대시보드</a>
    <a class="btn btn-en" href="/p/${dash.enSlug}">English Dashboard</a>
  </div>
