...
const HARNESS_COMPONENTS = [
  ...
  {
    category: 'entry',
    label: '한글 사전 (SKILLS_KR)',
    file: 'harness-mirror/docs/SKILLS_KR.md',
  ...
  {
    category: 'skill',
    label: '뉴스레터 만들기 (newsletter-make)',
  ...
  {
    category: 'skill',
    label: '뉴스레터 오류 해결 (newsletter-debug)',
