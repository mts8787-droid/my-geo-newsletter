  ...
  return (
    <div style={{ background: '#fff', border: '1px solid #E2E8F0', borderRadius: 12, overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
      <div style={{ padding: '16px 20px', borderBottom: '1px solid #E2E8F0' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 2 }}><span style={{ width: 3, height: 16, borderRadius: 8, background: '#CF0652', flexShrink: 0 }} /><h3 style={{ fontSize: 25, fontWeight: 700, color: '#111827', margin: 0 }}>정성 과제 현황</h3></div>
        <p style={{ fontSize: 22, color: '#64748B', margin: 0 }}>{month} 기준</p>
      </div>
        ...
        <table style={{ width: '100%', fontSize: 23, borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ background: '#F8FAFC', borderBottom: '1px solid #E2E8F0' }}>
              <th style={{ padding: '10px 12px', textAlign: 'left', fontSize: 21, fontWeight: 600, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em', minWidth: 80 }}>Stakeholder</th>
              ...
              <th style={{ padding: '10px 12px', textAlign: 'left', fontSize: 21, fontWeight: 600, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em', minWidth: 200 }}>목표 상세</th>
              <th style={{ padding: '10px 12px', textAlign: 'center', fontSize: 21, fontWeight: 600, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em', minWidth: 90 }}>{month} 달성</th>
            </tr>
          </thead>
          <tbody>
            {shList.map(sh => {
                ...
                return (
                  <tr key={sh} style={{ borderBottom: '1px solid #F1F5F9' }}>
                    <td style={{ padding: '9px 12px' }}>
                      <span style={{ display: 'inline-block', padding: '2px 8px', borderRadius: 4, fontSize: 21, fontWeight: 700, background: color + '18', color: '#111827', border: `1px solid ${color}30` }}>{sh}</span>
                    </td>
            ...
            {shList.length === 0 && (
              <tr>
                <td colSpan={5} style={{ padding: '32px 12px', textAlign: 'center', color: '#94A3B8', fontSize: 23 }}>
