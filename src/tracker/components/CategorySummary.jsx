  ...
  return (
    <div style={{ background: '#fff', border: '1px solid #E2E8F0', borderRadius: 12, overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
      <div style={{ padding: '16px 20px', borderBottom: '1px solid #E2E8F0', display: 'flex', alignItems: 'center', gap: 8 }}>
        <span style={{ width: 3, height: 16, borderRadius: 8, background: '#6366F1', flexShrink: 0 }} />
          ...
          return (
            <div key={cat.category} className="rounded-xl" style={{ border: `1px solid ${ms.border}`, background: ms.bg, padding: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                ...
                <span style={{ fontSize: 13, color: '#94A3B8' }}>{cat.taskCount}건</span>
              </div>

              {/* 월 달성률 */}
              <div style={{ marginBottom: 10 }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 }}>
                  <span style={{ fontSize: 13, color: '#64748B' }}>{month} 달성률</span>
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 }}>
                  <span style={{ fontSize: 13, color: '#64748B' }}>누적 달성률</span>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
