    ...
    <div style={{ background: '#fff', border: '1px solid #E2E8F0', borderRadius: 12, overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
      ...
      <div style={{ padding: '16px 20px', borderBottom: '1px solid #E2E8F0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          {totalWarnings > 0 && (
            <span style={{ fontSize: 17, fontWeight: 700, color: '#BE123C', background: '#FFF1F2', border: '1px solid #FECDD3', padding: '2px 8px', borderRadius: 4 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '140px 1fr 1fr', gap: 0, padding: '10px 20px 6px', borderBottom: '1px solid #F1F5F9' }}>
        <div style={{ fontSize: 16, fontWeight: 700, color: '#111827' }}>Stakeholder</div>
        <div style={{ fontSize: 16, fontWeight: 700, color: '#111827', textAlign: 'center' }}>{month} 달성률</div>
        <div style={{ fontSize: 16, fontWeight: 700, color: '#111827', textAlign: 'center' }}>누적 달성률</div>
      </div>
      ...
      <div style={{ padding: '0 20px 16px' }}>
            ...
            <div key={sh.name} style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  <span style={{ display: 'inline-block', padding: '3px 10px', borderRadius: 5, fontSize: 17, fontWeight: 700, background: color + '18', color: '#111827', border: `1px solid ${color}30` }}>
                    {sh.name}
                  </span>
              ...
              <div style={{ padding: '0 12px' }}>
                <div style={{ fontSize: 15, color: '#111827', marginBottom: 4 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <span style={{ fontSize: 19, fontWeight: 900, color: mSt.color, minWidth: 64, textAlign: 'right', fontVariantNumeric: 'tabular-nums' }}>
              ...
              <div style={{ padding: '0 12px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <span style={{ fontSize: 19, fontWeight: 900, color: cSt.color, minWidth: 64, textAlign: 'right', fontVariantNumeric: 'tabular-nums' }}>
        ...
        {filtered.length === 0 && (
          <p style={{ textAlign: 'center', color: '#94A3B8', padding: '16px 0', fontSize: 18 }}>해당 스테이크홀더가 없습니다.</p>
        )}
      </div>
    </div>
  )
