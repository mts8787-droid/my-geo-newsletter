            ...
            <div key={sh.name} style={{ borderBottom: '1px solid #F1F5F9', padding: '14px 0' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '120px 1fr 200px 200px', gap: 12, alignItems: 'center' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                  <span style={{ display: 'inline-block', padding: '4px 10px', borderRadius: 5, fontSize: 22, fontWeight: 700, background: color + '18', color: '#111827', border: `1px solid ${color}30`, textAlign: 'center' }}>
                    {sh.name}
                  </span>
                  <span style={{ fontSize: 19, color: '#64748B', textAlign: 'center' }}>
                    {sh.taskCount}건
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px 16px', fontSize: 19, color: '#475569' }}>
                ...
                {/* Month rate column */}
                <div>
                  <div style={{ fontSize: 19, color: '#64748B', marginBottom: 3, textAlign: 'center' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    ...
                    <span style={{ fontSize: 23, fontWeight: 900, color: mSt.color, minWidth: 60, textAlign: 'right', fontVariantNumeric: 'tabular-nums' }}>
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    ...
                    <span style={{ fontSize: 23, fontWeight: 900, color: cSt.color, minWidth: 60, textAlign: 'right', fontVariantNumeric: 'tabular-nums' }}>
