...
const RD_TEXT = {
  ...
  summary: '8월 LG.com의 전체적인 Readability 점수는 76.7점으로 전월 대비 0.8점 하락했습니다. 사이트별로는 글로벌 대표 사이트(lg.com/global)가 79.6점으로 가장 높았고, 국가 사이트 중에서는 스페인 78.5점이 최고, 인도 74.0점이 최저로 편차가 크지 않은 상황입니다.\n페이지 타입별로도 PDP 77.7점, 구매 가이드 73.2점으로 유사한 분포를 보이고 있습니다.',
  areaIntro: '반면 평가 영역별로는 점수 차이가 뚜렷하게 나타났습니다.\n사이트 성능 99.4점 (페이지 응답 및 정보 제공 속도), AI Crawlability 95.4점 (AI 크롤러가 원문을 가져갈 수 있는 기술 환경), Basic SEO 89.2점 (제목·페이지 주제 설명 등 검색되기위한 기본 정보), 웹접근성 83.5점 (사람과 AI가 문서 구조를 읽어낼 수 체계)으로 비교적 양호했습니다.\n반면, 스키마마크업 31.7점 (제품·FAQ·이미지 등 정보의 종류와 관계를 알려주는 구조화 데이터), 고인용 콘텐츠 42.8점 (AI가 인용할만한 서술의 존재)은 상대적으로 낮았습니다.',
  ...
  d4: '콘텐츠 영역은 42.8점으로 전월(29.3점) 대비 크게 상승했으나 스키마마크업 다음으로 낮은 수준입니다. AI가 질문에 대한 직접적인 답변으로 활용하기 쉬운 FAQ Block, Summary Box, Definition Paragraph 등의 콘텐츠가 충분하지 않아 보완이 필요한 상황이며, 현재 FAQ Block을 중심으로 각 사업본부 및 고객가치혁신의 주요 개선 과제로 추진 중입니다.\n한편, Citable Sentence(숫자, 연도, 통계, 연구 키워드 포함 문장)의 경우 전체 충족률은 57.0%였습니다. 캐나다(98.5%), 독일(98.1%), 호주(94.9%), 스페인(94.7%)은 충족률 90% 이상인 반면, 멕시코(5.5%)·인도(6.3%)·베트남(21.7%)·미국(37.9%)은 크게 낮아 국가별 편차가 매우 큰 상황입니다. 7월 독일 사이트를 비교해본 결과, LG.com의 Citable Sentence 충족률은 86.1%로 Samsung.com의 19.4%보다 크게 높아, LG 콘텐츠의 경쟁 우위 요소로 확인되었습니다. 향후 멕시코, 인도, 베트남, 미국 등 상대적으로 충족률이 낮은 국가에서도 Citable Sentence 확대를 통해 경쟁 우위 요소를 강화할 필요가 있습니다.\n콘텐츠의 작성자/출처/날짜 정보 충족률 또한 34.9%로 낮게 나타났습니다. 이는 AI가 콘텐츠의 신뢰성과 최신성을 판단하는 데 참고할 수 있는 요소인 만큼, 정보성 콘텐츠를 중심으로 보완이 필요합니다. 페이지 타입별로 보면 각 국가 사이트의 보도자료(Press&Media)는 74.3%로 양호한 반면, 구매 가이드와 LG Experience는 0%로 보완이 시급합니다.',
}
...
const RD_TEXT_EN = {
  ...
  summary: 'LG.com scored 76.7 overall for Readability in August, down 0.8 points month over month. By site, the global flagship (lg.com/global) led at 79.6; among country sites Spain was highest at 78.5 and India lowest at 74.0 \u2014 a narrow spread.\nPage types show a similar distribution: PDP 77.7, Buying Guide 73.2.',
  areaIntro: 'By assessment area, however, the gaps are pronounced.\nSite Performance 99.4 (page response and content delivery speed), AI Crawlability 95.4 (the technical conditions that let AI crawlers retrieve the source), Basic SEO 89.2 (the baseline information needed to be found \u2014 titles, page descriptions), and Accessibility 83.5 (structure that both people and AI can parse) were relatively strong.\nSchema Markup 31.7 (structured data that signals the type of information and how it relates) and Citable Content 42.8 (the presence of statements AI can quote) were comparatively low.',
