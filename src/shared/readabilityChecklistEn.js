...
export const CHECKLIST_EN = {
  ...
  '35': { name: 'Summary Box*', def: 'Whether a short summary of the key points sits near the top of the body', pass: 'One or more present' , method: 'Heading phrases (At a Glance, summary, etc., multilingual) or the p.info-desc summary block — class-name matching removed as a false-positive source' },
