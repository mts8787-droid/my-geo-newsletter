...
export const T = {
  ko: {
    ...
    htrP2: '<strong>Readability 점수</strong>는 <strong>전체 평가항목 중 기준을 충족한 항목의 비율(%)을 100점 기준으로 환산</strong>한 점수입니다. 평가는 사이트 성능, AI 웹접근성, Basic SEO 적합도, 스키마마크업, 고인용 콘텐츠, AI Crawlability의 <strong>6개 영역, 총 37개 체크리스트</strong>를 기준으로 진행했습니다. 각 항목의 정의와 판정 기준은 <strong>검수 기준 탭</strong>과 대시보드 내 <strong>항목별 간략 설명</strong>에서 확인하실 수 있습니다.',
  ...
  en: {
    ...
    htrP2: 'The <strong>Readability score</strong> is <strong>the share of checklist items meeting the bar, normalised to a 100-point scale</strong>. The assessment covers <strong>6 areas and 37 checklist items in total</strong> — Site Performance, AI Accessibility, Basic SEO, Schema Markup, Citable Content, and AI Crawlability. Definitions and pass criteria for each item are on the <strong>Criteria tab</strong> and in the <strong>per-item notes</strong> on this dashboard.',
