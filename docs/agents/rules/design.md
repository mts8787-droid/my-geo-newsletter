...
### 5.15 차트 분류 카탈로그 (Chart Library)

14 차트 양식 + 1 직교 패턴 (툴팁) — 분류 코드 시스템. 스킬에서 코드로 호출.

| 코드 | 양식 | 위치 |
|---|---|---|
| **L-1** | Basic Line | §5.11 #1 |
| **L-2** | Interpolation (곡선) | §5.11 #2 |
| **L-3** | Multi-axis | §5.11 #3 |
| **L-4** | Point Styling | §5.11 #4 |
| **L-5** | Segments (베이스라인 fade) | §5.11 #5 |
| **L-6** | Stepped | §5.11 #6 |
| **L-7** | Styling | §5.11 #7 |
| **B-1** | Stacked Bar | §5.14 #1 |
| **B-2** | Stacked Groups | §5.14 #2 |
| **M-1** | Combo Bar+Line | §5.12 #2 |
| **M-2** | Stacked Bar+Line | §5.12 #4 |
| **D-1** | Doughnut | §5.12 #3 |
| **R-1** | Radar (skip points) | §5.12 #5 |
| **BU-1** | Bubble (X/Y/r) | §5.12 #1 |
| **T-1** | Tooltip (직교 패턴) | §5.13 |
